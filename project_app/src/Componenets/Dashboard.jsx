...
const Dash=()=>{
  ...
  <div className="row">
        <div className="col-md-3" id="card1">
    
            <div>
              <p>Today Total Drivers</p>
              <h1>256</h1>
            </div>
         </div>
        <div className="col-md-3" id="card2">

           <div>
              <p>Today Present Drivers</p>
              <h1>226</h1>
            </div>
         </div>
     <div className="col-md-3" id="card3">
          <div>
              <p>Today Adjustment Drivers</p>
              <h1>10</h1>
        </div>
      ...
      <div className="row">
        <div className="col-md-3" id="cards1">
        <div>
              <p>Today Total Cleaners</p>
              <h1>180</h1>
          </div>
        </div>
        <div className="col-md-3" id="cards2">
        <div>
              <p>Today Present Cleaners</p>
              <h1>146</h1>
            </div>
        </div>
     <div className="col-md-3" id="cards3">
          <div>
              <p>Today Adjustment Cleaners</p>
              <h1>14</h1>
            </div>
     </div>
        <div className="col-md-3" id="cards4">
        <div>
              <p>Today Absent Cleaners</p>
              <h1>20</h1>
            </div>
       </div> 
      </div>
